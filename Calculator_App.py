...
cal = Tk()
cal.title("Sly's Calculator")
operator = ""
text_Input = StringVar()

txtDisplay = Entry(cal, font = ("arial", 20, "bold"), textvariable = text_Input, bd = 30, insertwidth = 2, 
...
Btnbracket1 = Button(cal, padx = 16, pady = 16, bd = 8, fg = 'black', font = ('arial', 20, 'bold'),
